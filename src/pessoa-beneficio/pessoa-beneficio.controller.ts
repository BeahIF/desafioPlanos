...
export class PessoaBeneficioController {
  ...
  @Put(':id')
  async updatePessoaBeneficio(
    @Param('id') id: string,
    @Body() pessoaBeneficio,
  ) {
    return this.pessoaBeneficioService.updatePessoaBeneficio(
      Number(id),
      pessoaBeneficio,
    );
  }
  ...
  async deletePessoaBeneficio(@Param('id') id: string) {
    return this.pessoaBeneficioService.deletePessoaBeneficio(Number(id));
  }
}
